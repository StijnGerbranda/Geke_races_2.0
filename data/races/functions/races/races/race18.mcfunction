...
execute if score @s leaves matches 1.. run function races:races/race_specific_functions/tortle/reset_wet_timer
...
execute at @s if predicate races:inwater run function races:races/race_specific_functions/tortle/water_timer
execute at @s unless predicate races:inwater run function races:races/race_specific_functions/tortle/reset_water_timer